...
//   API_URL = 'http://simrs-rspusatpolri.com:9000/service/';
//   // API_URL = 'http://103.93.237.70:9000/service/';
//   // API_URL = 'http://202.51.105.98:9000/service/';
...
//     });
//     return this.httpClient.get(this.API_URL + 'medifirst2000/reservasionline/get-pasien/'+x, { headers: headers }).pipe(
//       timeout(8000),
//       tap(Data => {
//         return Data;
//       })
...
export class AppService {
  ...
  constructor(http: HttpClient, @Inject(Window) private window: Window) {
    ...
    if (this.window.location.hostname.indexOf('localhost') > -1) {
      this.urlPrefix = 'http://94.74.86.174:8080/api/';
      this.urlLogin = 'http://94.74.86.174:8080/api/login';
      this.urlLogout = 'http://94.74.86.174:8080/api/login';
    } else if (this.window.location.hostname.indexOf('202.51.105.98') > -1) {
      this.urlPrefix = 'http://202.51.105.98:9000/service/medifirst2000/';
      this.urlLogin = 'http://202.51.105.98:9000/service/medifirst2000/auth/sign-in';
      this.urlLogout = 'http://202.51.105.98:9000/service/medifirst2000/auth/sign-out';
    } else if (this.window.location.hostname.indexOf('10.10.20.167') > -1) {
      this.urlPrefix = 'http://10.10.20.167:9000/service/medifirst2000/';
      this.urlLogin = 'http://10.10.20.167:9000/service/medifirst2000/auth/sign-in';
      this.urlLogout = 'http://10.10.20.167:9000/service/medifirst2000/auth/sign-out';
    }  else {
      this.urlPrefix = 'http://192.168.1.7:9000/service/medifirst2000/';
      this.urlLogin = 'http://192.168.1.7:9000/service/medifirst2000/auth/sign-in';
      this.urlLogout = 'http://192.168.1.7:9000/service/medifirst2000/auth/sign-out';
    }
  }
